...
4. Stories are saved as individual files in domain folders (`.launchcraft/[domain]/stories/US-NNN-[slug].md`) with a global index at `.launchcraft/user-stories-index.md`
